...
import com.fangmingdong.androiddemo.widgets.SimpleTextAdapter;
...
public class YouDaoMineActivity extends AppCompatActivity {
    ...
    private static final String TAG = YouDaoMineActivity.class.getSimpleName();
