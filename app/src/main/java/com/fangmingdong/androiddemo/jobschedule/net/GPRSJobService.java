...
public class GPRSJobService extends JobService {
    private static final String TAG = GPRSJobService.class.getSimpleName();
    private Observable<String> mObservable;
    public static final String SP_KEY = "GPRSJobService onStartJob";
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        SharedPreferences.Editor onStartJob = sp.edit().putString(SP_KEY, "gprs start");
        onStartJob.commit();
